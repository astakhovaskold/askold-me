      ...
      $.ajax({
        ...
        success: function (response) {
          try {
            ...
            input.val("").removeClass("invalid").removeClass("valid");
            alert
              .text("Произошла ошибка. Приносим свои извинения.")
              .removeClass("valid")
              .addClass("invalid")
              .fadeIn();
          }
...
jQuery(function ($) {
  ...
  if ($('input[name="reCAPTCHA"]').length) {
    let siteKey = "6LcYPMgZAAAAAAXBc5udAJjULAhoMbJD7qHxwdbN"; // Put your site key here
...
jQuery(function ($) {
  ...
  if (cookieNotice) {
    ...
    gdprCookieNotice({
      ...
      statement: "https://askold.me", // Link to your cookie statement page
